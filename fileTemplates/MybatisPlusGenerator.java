...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mybatis-3?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        templateConfig.setXml(null);
        ...
        strategy.setInclude("tbl_employee"); //生成表的名字
